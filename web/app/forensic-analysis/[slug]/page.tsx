...
function Body() {
  ...
  const found = findDocBySlug("forensic-analysis", slug);
  if (!found) notFound();
  ...
  return (
    <>
      <DocumentDetail
        parentRoute="/forensic-analysis"
        parentLabel="forensic analysis"
        doc={found!.doc}
        lore={found!.lore}
        idx={idx}
        docs={docs}
...
export default function ForensicAnalysisDocPage() {
  return (
